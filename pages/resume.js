  ...
  <>
    ...
    <Container>
      ...
      <p>
        ...
        day-to-day engineering and project/account management of new and
        existing clients. Worked with Obey, Hugh & Crye and range of small to
      ...
      <p>
        ...
        engineering for clients including Spotify, Intel, and Mindjet.
      </p>
      ...
      <p>
        ...
        <strong>Webpack</strong>. And powered by a headless <strong>CMS</strong>{" "}
        or a <strong>RESTful</strong> database.
      </p>
      <Footer />
    </Container>
  </>
